...
import com.howard.www.hospital.queue.operation.websocket.listener.WebSocketSubscribeListener;
 ...
 */
public class HospitalQueueStompSubProtocolHandler implements SubProtocolHandler, ApplicationEventPublisherAware{
	...
	public void handleMessageFromClient(WebSocketSession session,
        ...
        logger.info("execute HospitalQueueStompSubProtocolHandler  handleMessageFromClient");
	...
	public void assigningParameters(StompSubProtocolHandler stompSubProtocolHandler,ApplicationContext cApplicationContext)throws Exception{
		this.setApplicationEventPublisher(cApplicationContext);
		this.setErrorHandler(stompSubProtocolHandler.getErrorHandler());
		this.setHeaderInitializer(stompSubProtocolHandler.getHeaderInitializer());
		this.setMessageSizeLimit(stompSubProtocolHandler.getMessageSizeLimit());
		
	}
 
	public HospitalQueueStompSubProtocolHandler(SubProtocolHandler subProtocolHandler,ApplicationContext cApplicationContext)throws Exception{
		assigningParameters((StompSubProtocolHandler)subProtocolHandler,cApplicationContext);
	}
}
