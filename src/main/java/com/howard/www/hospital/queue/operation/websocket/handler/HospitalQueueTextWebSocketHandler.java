...
public class HospitalQueueTextWebSocketHandler extends TextWebSocketHandler {
	protected final Logger log = LoggerFactory.getLogger(HospitalQueueTextWebSocketHandler.class);
	@Override
